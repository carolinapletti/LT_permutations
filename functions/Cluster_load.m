    ...
    for chan = 1:length(data)
        ...
        if ch1 == ch2
            ...
            if ch2 > ch1
                ...
                temp_avg = nanmean(cat(3, temp_1, temp_2), 3);
        ...
        matrixAvgVert = squeeze(nanmean(matrixVert, 1)); % Average across each group of 3 rows
        ...
        chan_matrix = squeeze(nanmean(matrixHoriz, 2)); % Average across each group of 3 columns
